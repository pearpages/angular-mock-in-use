describe('omdb service', function() {
    ...
    it('should return search movie data for search query', function() {
        ...
        angular.mock.module('omdb'); //we can either mock them module with the functionality we need
        //or we can call the module itself. For the first, see next commented lines        
